...
public class DBConstants {
    ...
    public static final String RECCURING_USER = "SELECT count(VEHICLE_REG_NUMBER) FROM ticket GROUP BY VEHICLE_REG_NUMBER HAVING count(VEHICLE_REG_NUMBER) > 5 AND VEHICLE_REG_NUMBER = ?";
}
